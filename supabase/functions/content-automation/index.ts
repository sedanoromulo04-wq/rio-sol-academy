...
async function generateMindMap(videoId: string): Promise<string> {
  return geminiRequest({
    contents: [{ role: 'user', parts: [
      youtubePart(videoId),
      { text: [
        'INSTRUCAO: Crie um mapa mental profissional e visualmente organizado em Markdown.',
        '',
        'REGRAS DE FORMATACAO:',
        '- Primeira linha: "# 🧠 [Tema Central em maiusculas]"',
        '- Ramos principais: "## 🔷 Titulo do Ramo" (use emojis profissionais e variados para cada ramo)',
        '- Sub-topicos: "- **Conceito:** descricao curta e direta"',
        '- Sub-sub-topicos: "  - descricao objetiva"',
        '- Use emojis relevantes ao contexto em cada item (ex: 📊 para dados, 💰 para vendas, 🎯 para metas, ⚙️ para tecnico, 🤝 para relacionamento)',
        '- Palavras-chave em **negrito**',
        '- Maximo 6 ramos principais, cada um com 3-5 sub-topicos',
        ...
        '',
        '## 🎯 Primeiro Ramo',
        '- **Conceito-chave:** explicacao curta',
        '  - detalhe importante',
        '  - detalhe importante',
        '- **Outro conceito:** explicacao',
        '',
        '## 📊 Segundo Ramo',
        '- **Conceito:** explicacao',
        '',
        'Nao inclua texto introdutorio antes do mapa. Comece direto com o "#".',
      ].join('\n') },
    ]}],
